...
import { Search, Star, Clock, Droplets, Plus, Copy, Trash2, Edit3 } from 'lucide-react';
...
const TemplateSelector: React.FC<TemplateSelectorProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl w-full max-w-5xl max-h-[85vh] flex flex-col">
        {/* Header */}
        ...
        <div className={`p-4 border-b ${categoryInfo.color}`}>
